...
class _FilterState extends State<Filter> {
  ...
  @override
  void initState() {
    searchForm = FormEmployee(onSubmit: (context,form){},onCancel: (context){});
    _filterItems();
    super.initState();
  }
    ...
    return Theme(
      ...
      child: BackdropScaffold(
        appBar: BackdropAppBar(
          title: const Text("Filtros aplicados"),
        ),
  ...
  Widget _createBackLayer() => Column(
    ...
    children: [
      ...
      /*earchForm.getItem("name")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("birthday")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("salary")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("number")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("percentage")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("country")?.draw(context)??SizedBox.shrink(),
      searchForm.getItem("rememberMe")?.draw(context)??SizedBox.shrink(),*/
      searchForm.draw(context),
      /*
      ListView.builder(
